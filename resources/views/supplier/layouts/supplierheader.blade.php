    ...
    <nav class="menu_section">
        <div class="container">
            <ul class="menu menu2">
                ...
                <li>
                    <a href="{{ route('suppliercompanydashborad') }}" class="{{ request()->is('supplier/com*') ? 'active' : '' }}">Company Details,Brands & Users</a>
                    <ul class="sub-menu {{ request()->is('supplier/com*') ? 'open' : '' }}">
                        ...
                        <li><a href="{{ route('supplierbrand') }}" class="{{ request()->is('supplier/companyadd') ? 'active' : '' }}">Brands</a></li>
