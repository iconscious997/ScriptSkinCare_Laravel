            ...
            <table class="table display" id="customers">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="flex">
                            <a href='retail-site-edit/{{$item->id}}' data-id={{$item->id}}><button type="button" class="btn btn-default "> EDIT</button></a> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        Search Manage / Edit A Retail site List
                                    </a>
                                </h4>
                            </div>
                        ...
                        <form action="{{ url('/retail-site-list') }}" method="post">
@csrf
                                            <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="clinic_name" placeholder="Registered Business Name:" value="{{$request->clinic_name}}" >
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="telephone_number"  placeholder="Business Telephone:" value="{{$request->telephone_number}}">
                                                </div>
                                                  <div class="form-group">
...
<option value="1"{{ isset($request->status)?($request->status== 1 ? 'selected' : ''):('') }} >Deactive</option>
                                            ...
                                            <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="clinic_website" placeholder="Website:" value="{{$request->clinic_website}}" >
                                                </div>
